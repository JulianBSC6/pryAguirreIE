...

{
    ...
    internal class clsBaseDatos
    {
        ...
        public void TraerDatos(DataGridView Grilla)
        {
            ...
            comandBD.CommandText = "SOCIOS";//La tabla que trae
        ...
        public void CrearCuenta()
        {
            try
            {
                ...
                DataSet objDataSet = new DataSet();
                    ...
                    conexionBD = new OleDbConnection();
                    string rutaArchivo = @"../../Archivos/BDusuarios.accdb";
                    string Conexion = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + rutaArchivo;
                ...
                nuevoRegistro["Nombre"] = frmRegistrarCuenta.Usuario;
                nuevoRegistro["Contraseña"] = frmRegistrarCuenta.ContraseñaIguales;
                nuevoRegistro["Perfil"] = frmRegistrarCuenta.Perfil;
